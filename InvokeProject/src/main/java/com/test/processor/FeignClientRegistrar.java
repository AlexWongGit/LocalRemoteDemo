...
//        scanner.addIncludeFilter(new AnnotationTypeFilter(FeignClients.class));
//
...
//                if (annotationMetadata.hasAnnotation(FeignClients.class.getName())) {
//                    Map<String, Object> attributes = annotationMetadata.getAnnotationAttributes(FeignClients.class.getName());
...
//                return beanDefinition.getMetadata().isInterface() && beanDefinition.getMetadata().hasAnnotation(FeignClients.class.getName());
//            }
//        };
//    }
//}